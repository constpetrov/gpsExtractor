...
public class RogainActivity extends GpsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        layout.setWindowParameters(0,
                getResources().getDisplayMetrics().heightPixels - getStatusBarHeight()- getTitleBarHeight(),
                0,
                getResources().getDisplayMetrics().widthPixels);

        testText = (TextView)findViewById(R.id.testText);
        testText.setText("Width = " + getResources().getDisplayMetrics().widthPixels +
    ...
    private String createMovementParametersList(){
        ...
        if(GpsEngine.getEngine() != null){
            builder.append("Speed ").append(format.format(GpsEngine.getEngine().getCurrentSpeed())).append(" km/h").append("\n");
            builder.append("Distance ").append((int)GpsEngine.getEngine().getTripDistance()).append(" meters").append("\n");
            builder.append("Time spent ").append(formatTime(GpsEngine.getEngine().getTripTime())).append("\n");
            builder.append("Average speed ").append(format.format(GpsEngine.getEngine().getAverageSpeed())).append(" km/h").append("\n");
        }
