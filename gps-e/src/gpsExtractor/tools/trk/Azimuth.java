...
/**
 * Created by IntelliJ IDEA. User: kpetrov Date: 1/30/12 Time: 9:25 PM To change
...
public class Azimuth {
    ...
    private final static DecimalFormat hundredKmFormat = new DecimalFormat(
        "00.0");

    private final static DecimalFormat thousandKmFormat = new DecimalFormat(
        "000");

    static {
        tenKmFormat.setDecimalFormatSymbols(new DecimalFormatSymbols(
            Locale.ENGLISH));
        hundredKmFormat.setDecimalFormatSymbols(new DecimalFormatSymbols(
            Locale.ENGLISH));
        thousandKmFormat.setDecimalFormatSymbols(new DecimalFormatSymbols(
            Locale.ENGLISH));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (Double.compare(azimuth.angle, angle) != 0)
            return false;
        if (Double.compare(azimuth.distance, distance) != 0)
            return false;
    ...
    private String printDirection() {
        ...
        String[] direction =
            { "N", "NNE", "NE", "NEE", "E", "SEE", "SE", "SSE", "S", "SSW",
                "SW", "SWW", "W", "NWW", "NW", "NNW" };
        return direction[i];
    }
